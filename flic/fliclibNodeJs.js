/**
 * PLACEHOLDER - Flic Client Library for Node.js
 *
 * This file is a placeholder. You must download the actual library from:
 * https://github.com/50ButtonsEach/fliclib-linux-hci/blob/master/clientlib/nodejs/fliclibNodeJs.js
 *
 * Instructions:
 * 1. Go to the URL above
 * 2. Click "Raw" to see the raw file
 * 3. Save the file (Ctrl+S / Cmd+S) as fliclibNodeJs.js
 * 4. Replace this placeholder file with the downloaded file
 *
 * The library provides:
 * - FlicClient: Connects to the FlicSDK daemon
 * - FlicConnectionChannel: Listens to button events
 * - FlicScanWizard: Discovers and pairs new buttons
 */
